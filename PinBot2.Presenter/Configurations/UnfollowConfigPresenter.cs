...
{
    public class UnfollowConfigPresenter
    {
        private readonly bool IS_PREMIUM;
        private readonly IConfigureView _view;
        private readonly IAccountRepository _repository;

        public UnfollowConfigPresenter(IAccountRepository repository, IConfigureView view, bool IS_PREMIUM)
        {
        ...
        public void ShowForm(IUnfollowConfiguration con)
        {
            _view.ShowForm(con);
        }
    }
